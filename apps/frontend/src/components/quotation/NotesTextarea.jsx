  ...
  return (
    <div className="space-y-4 text-left">
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Notes & Comments</h4>
          <p className="text-[11px] text-slate-400 font-medium">Specify payment terms, warranty, or delivery conditions.</p>
        </div>
      ...
      <div className="relative">
        <textarea
          ...
          className={`w-full bg-slate-50 border ${
            errors.notes ? 'border-rose-300 focus:ring-rose-500' : 'border-slate-250 focus:ring-[#714B67]'
