  ...
  const cards = [
    ...
    },
    {
      ...
      metric1: {
        ...
        value: notifications.filter((n) => n.title.includes('Approval') && !n.read).length,
      },
      metric2: {
        label: 'Rejected Requests',
        value: timeline.filter((l) => l.action.toLowerCase().includes('reject')).length,
      },
    },
    {
      ...
      metric2: {
        ...
        value: timeline.filter((l) => l.action.toLowerCase().includes('paid')).length,
      },
    },
    {
      title: 'Audit Events',
